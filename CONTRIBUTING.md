# Contributing to nmdc-lakehouse-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
nmdc-lakehouse-schema. These guidelines are not strict rules.
...
The nmdc-lakehouse-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the nmdc-lakehouse-schema technical leads
...
[issues]: https://github.com/microbiomedata/nmdc-lakehouse-schema/issues/
[pulls]: https://github.com/microbiomedata/nmdc-lakehouse-schema/pulls/
