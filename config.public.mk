...
# Schema documented and published on the docs site. This is the product schema
# (the flattened, tabular target generated by `just generate-flat-schema`), which
# differs from LINKML_SCHEMA_NAME (the package/datamodel name used by gen-project).
LINKML_DOC_SCHEMA_NAME="nmdc_schema_flattened"
