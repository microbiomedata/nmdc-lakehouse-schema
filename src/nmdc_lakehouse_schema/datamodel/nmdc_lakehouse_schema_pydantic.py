...
linkml_meta = LinkMLMeta({'default_prefix': 'nmdc_lakehouse_schema',
     'default_range': 'string',
     'description': 'This is the project description.',
     'id': 'https://w3id.org/microbiomedata/nmdc-lakehouse-schema',
     'imports': ['linkml:types'],
     'license': 'Apache-2.0',
     'name': 'nmdc-lakehouse-schema',
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'nmdc_lakehouse_schema': {'prefix_prefix': 'nmdc_lakehouse_schema',
                                            'prefix_reference': 'https://w3id.org/microbiomedata/nmdc-lakehouse-schema/'},
                  'schema': {'prefix_prefix': 'schema',
                             'prefix_reference': 'http://schema.org/'}},
     'see_also': ['https://microbiomedata.github.io/nmdc-lakehouse-schema'],
     'source_file': 'src/nmdc_lakehouse_schema/schema/nmdc_lakehouse_schema.yaml',
     'title': 'nmdc-lakehouse-schema'} )
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/microbiomedata/nmdc-lakehouse-schema'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/microbiomedata/nmdc-lakehouse-schema',
